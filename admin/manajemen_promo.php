...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container" style="padding:50px;">
      ...
      <center> <h1>Manajemen Promo</h1> </center>
      <br>
      <br>

      <a href="lihat_user.php"> <button type="button" class="btn btn-primary btn-md btn-block">Lihat User</button> </a>
      <br>
      <a href="tambah_user.php"> <button type="button" class="btn btn-primary btn-md btn-block">Tambah User</button> </a>
      <br>
