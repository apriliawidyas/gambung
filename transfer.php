            ...
            <div class="row pembayaran bg-light">
               <div class="col-lg-12">
                <form action="" enctype="multipart/form-data" method="post">
                    ...
                    <p style="text-align: center;">Silahkan transfer sesuai dengan nominal dan kirim ke rekening <strong>Bank BJB</strong> berikut</p>
                    <h1 style="font-weight: bold;line-height: 0px; font-size: 30px">0086197911100</h1>
                    <p style="font-size: 20px; color: black; margin-top: 25px; text-align: center">a/n</p>
                    <h4 style="text-align: center; font-weight: bold; margin-bottom: 80px">Bumdes Pakis Sabilulungan</h4>
