...
<body>
  <div class="container" style="padding:50px;">
      ...
      <center> <h1>Selamat Datang <?php echo $_SESSION['nama_depan']; ?></h1> </center>
      <br>
      <br>

      <a href="manajemen_user.php"> <button type="button" class="btn btn-primary btn-md btn-block">Manajemen User</button> </a>
      <br>
      <a href="manajemen_promo.php"> <button type="button" class="btn btn-primary btn-md btn-block">Manajemen Promo</button> </a>
      <br>
      <a href="manajemen_transaksi.php"> <button type="button" class="btn btn-primary btn-md btn-block">Manajemen Transaksi</button> </a>
      <br>
