...
<footer>
  <div class="row footer">
    <div class="col-lg-3 col-xs-12">
      <img src="image/gambung.png" alt="logo" height="120px" width="100%">
    </div>
    <div class="col-lg-3 col-xs-12">
      <h5>Kontak</h5>
      <p>Jl Raya Gambung RT 3 RW 8 Desa Mekarsari</p>
      <p>Contact Person</p>
      <p>Muhammad Ramdan : +62 85886982764</p>
      <p>Syam Shahid : +62 85795852874</p>
    </div>
    <div class="col-lg-3 col-xs-12">
      <h5>Menu</h5>
      <p>Product</p>
